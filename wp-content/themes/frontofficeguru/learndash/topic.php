...
<script type="text/javascript">
	jQuery(document).ready(function () {
		...
		jQuery("#learndash_next_prev_link > a.next-link").html("Next Topic<div class='arrow_right'></div>");

		jQuery("#learndash_next_prev_link > a.prev-link").html("<div class='arrow_left'></div>Previous Topic");
